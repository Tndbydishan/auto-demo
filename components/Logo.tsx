    ...
    >
      ...
      >
        ...
        <g className="logo-shapes-group">
          <polygon fill="#d02029" points="36.68 72.17 52.89 72.17 72.65 25.54 56.44 25.55 36.68 72.17"/>
          <polygon fill="#d02029" points="88.12 46.63 104.34 46.63 124.1 0 107.89 0 88.12 46.63"/>
          <polygon fill="#d02029" points="76.98 25.06 93.2 25.05 78.83 58.98 62.61 58.98 76.98 25.06"/>
          
          <polygon fill="currentColor" points="42.26 58.99 58.48 58.99 78.24 12.36 62.03 12.37 42.26 58.99"/>
          <polygon fill="currentColor" points="82.89 58.98 99.11 58.98 118.87 12.35 102.65 12.35 82.89"/>
          <path fill="currentColor" d="M22.04,59.02h16.03S57.83,12.4,57.83,12.4l-26.33-.27c-7.07-.07-13.48,4.14-16.23,10.66L0,59.03h16.15l14.91-35.12c.36-.85.92-1.59,1.64-2.17l6.02-4.61h1.08s-17.76,41.89-17.76,41.89Z"/>
        </g>
      </svg>
    </Component>
  );
